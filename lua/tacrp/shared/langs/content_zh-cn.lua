...
L["att.ammo_rpg_shovel.name.full"] = "RPG-7 铲子火箭"
L["att.ammo_rpg_shovel.name"] = "铲子"
L["att.ammo_rpg_shovel.desc"] = "以神秘的方式发射铲子。你是疯了，火箭用完了，还是两个都有？"
...
L["att.muzz_supp_tactical.name.full"] = "战术消音器"
L["att.muzz_supp_tactical.name"] = "战术消音"
L["att.muzz_supp_tactical.desc"] = "降低后坐力和射程的平衡类消音器。"
...
L["att.optic_rds.name.full"] = "红点瞄准镜"
L["att.optic_rds.name"] = "红点"
L["att.optic_rds.desc"] = "视野宽敞的低倍瞄准器。"

L["att.optic_aimpoint.name.full"] = "Aimpoint 瞄准镜"
L["att.optic_aimpoint.name"] = "Aimpoint"
L["att.optic_aimpoint.desc"] = "桶状准镜，可辅助近距离瞄准。"
