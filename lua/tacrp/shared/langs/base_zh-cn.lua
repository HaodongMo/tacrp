...
L["stat.recoilkick"] = "视觉后坐力"
L["stat.recoilkick.desc"] = "基于\"视觉后坐力\"使枪械的准星移动"
L["stat.recoilspread"] = "后坐力扩散"
L["stat.recoilspread.desc"] = "枪械的不准确度。\n较大的数值意味着枪械会在连续射击时变得更不准确。"
L["stat.recoildissipation"] = "后坐力复位"
L["stat.recoildissipation.desc"] = "积累后坐力释放速度。\n较大的数值意味着后坐力在复位时间后影响更快消失。"
L["stat.recoilresettime"] = "后坐力复位时间"
L["stat.recoilresettime.desc"] = "后坐力开始消散前的延迟时间。\n较大的数值意味着你必须在两次射击之间要等待更长时间，后坐力影响才会开始复位。"
L["stat.recoilmaximum"] = "最大后坐力"
L["stat.recoilmaximum.desc"] = "连续射击造成的后坐力的上限。"
L["stat.recoilfirstshot"] = "第一枪后坐力率"
L["stat.recoilfirstshot.desc"] = "连续射击时第一枪的后坐力倍率。在所有后坐力复位后重置。\n不影响视觉后坐力。"
L["stat.recoilpershot"] = "后坐力增益"
