...
L["wep." .. w .. ".desc.quote"] = "Saw extensive use in the Battle for Paris."
...
L["wep." .. w .. ".desc"] = "A customized battle rifle, chambered for a magnum hunting round that announces its presence with a thunderous report and bombastic muzzleflash."
