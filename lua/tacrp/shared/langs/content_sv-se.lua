...
L["quicknade.dettype.1.5"] = "Tid: 1,5s"
L["quicknade.dettype.2"] = "Tid: 2s"
L["quicknade.dettype.2.remote"] = "Tid: 2s / Fjärr"
L["quicknade.dettype.3"] = "Tid: 3s"
L["quicknade.dettype.5"] = "Tid: 5s"
L["quicknade.dettype.remote"] = "Fjärr"
L["quicknade.dettype.blunt"] = "Trubbigt våldstrauma"
L["quicknade.dettype.mine"] = "Tryckplatta"
...
L["quicknade.t-smoke.name"] = "T-RÖK"
L["quicknade.t-smoke.desc"] = "Terroristutfärdad rökgranat.\n\nSkapar en rökskärm."

L["quicknade.t-discombobulator.name.full"] = "Discombobulator"
L["quicknade.t-discombobulator.name"] = "T-DCB"
L["quicknade.t-discombobulator.desc"] = "Terroristutfärdad chockgranat.\n\nGör ingen skada, men skapar en sprängning som trycker in föremål och spelare ut."

L["quicknade.t-incendiary.name.full"] = "Brandgranat"
L["quicknade.t-incendiary.name"] = "T-ELD"
L["quicknade.t-incendiary.desc"] = "Terroristutfärdad brandgranat.\n\nSprängs med minimal skada, men påbörjar en brand ett område."
...
L["att.ammo_rpg_shovel.name.full"] = "RPG-7 Spade \"Granat\""
L["att.ammo_rpg_shovel.name"] = "Spade"
L["att.ammo_rpg_shovel.desc"] = "På något sätt så skjuter den spadar. Antingen är du galen, slut på granater, eller både och."
...
L["att.muzz_supp_tactical.name.full"] = "Taktisk Ljuddämpare"
L["att.muzz_supp_tactical.name"] = "T. Ljuddämp."
L["att.muzz_supp_tactical.desc"] = "Balanserad ljuddämpare som sänker rekylen och effektiva räckvidden."
...
L["att.optic_rds.name.full"] = "Rödpunktsikte"
L["att.optic_rds.name"] = "Rödpunkt"
L["att.optic_rds.desc"] = "Öppet reflexsikte med en klar vy."

L["att.optic_aimpoint.name.full"] = "Aimpoint-Sikte"
L["att.optic_aimpoint.name"] = "Aimpoint"
L["att.optic_aimpoint.desc"] = "Rörsikte för att hjälpa med målförvärv på nära distans."

L["att.optic_rmr.name.full"] = "RMR Reflex-Sikte"
