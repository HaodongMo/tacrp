...
L["stat.recoilspread"] = "Bloom added to Spread"
L["stat.recoilspread.desc"] = "Spread added per unit of bloom.\nLarger value means the weapon becomes inaccurate faster during rapid fire."
L["stat.recoilspread2"] = "Bloom added to Recoil"
L["stat.recoilspread2.desc"] = "Recoil applied per unit of bloom.\nLarger value means the weapon's recoil intensifies more during rapid fire."
...
L["stat.recoilfirstshot.desc"] = "Bloom multiplier when firing the first shot in a burst.\nApplies when there is no accumulated bloom."
...
L["stat.holstertime"] = "Holster Duration"
...
L["stat.damage_max.desc"] = "Damage dealt by the weapon."
L["stat.damage_max"] = "Close Range Damage"
L["stat.damage_max.desc"] = "Total damage per shot at no range falloff or rampup."
L["stat.damage_min"] = "Long Range Damage"
L["stat.damage_min.desc"] = "Total damage per shot at maximum range falloff or rampup."
