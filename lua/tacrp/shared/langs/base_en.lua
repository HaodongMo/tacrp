...
L["stat.recoilspread"] = "Bloom Spread"
L["stat.recoilspread.desc"] = "Inaccuracy per unit of bloom. Larger value means the weapon becomes\ninaccurate faster while continuously firing."
L["stat.recoilspread2"] = "Bloom Recoil"
